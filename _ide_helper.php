 ...
 * Generated for Laravel 5.5.50 on 2021-04-14 20:29:59.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            ...
            return \Proto\Console\Kernel::handle($input, $output);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Proto\Console\Kernel::terminate($input, $status);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Proto\Console\Kernel::command($signature, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Proto\Console\Kernel::registerCommand($command);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Proto\Console\Kernel::call($command, $parameters, $outputBuffer);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Proto\Console\Kernel::queue($command, $parameters);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Proto\Console\Kernel::all();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Proto\Console\Kernel::output();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Proto\Console\Kernel::bootstrap();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Proto\Console\Kernel::setArtisan($artisan);
        }
    ...
    class Auth {
         ...
         *
         * @param mixed $id
         * @return \Proto\Models\User|false 
         * @static 
         */ 
        ...
        {
            \Illuminate\Auth\SessionGuard::basic($field, $extraConditions);
        }
        ...
        {
            \Illuminate\Auth\SessionGuard::onceBasic($field, $extraConditions);
        }
...
namespace Biscolab\ReCaptcha\Facades { 
    ...
    class ReCaptcha {
         ...
         * @static 
         */ 
        public static function htmlFormSnippet($attributes = array())
        {
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::htmlFormSnippet($attributes);
        }
        ...
        {
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::getTagAttributes();
        }
        ...
        {
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::getOnLoadCallback();
        }
         ...
         * @static 
         */ 
        public static function cleanAttributes($attributes = array())
        {
        ...
        public static function setApiSiteKey($api_site_key)
        {
            ...
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::setApiSiteKey($api_site_key);
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::setApiSecretKey($api_secret_key);
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::getCurlTimeout();
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::setVersion($version);
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::getVersion();
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::setSkipByIp($skip_by_ip);
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::setApiDomain($api_domain);
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::getApiDomain();
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::setApiUrls();
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::getIpWhitelist();
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::skipByIp();
        }
         ...
         * @static 
         */ 
        public static function htmlScriptTagJsApi($configuration = array())
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::htmlScriptTagJsApi($configuration);
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::validate($response);
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::getApiSiteKey();
        }
        ...
        {
            //Method inherited from \Biscolab\ReCaptcha\ReCaptchaBuilder            
            return \Biscolab\ReCaptcha\ReCaptchaBuilderV2::getApiSecretKey();
        }
...
namespace Mollie\Laravel\Facades { 
    ...
    class Mollie {
        ...
        {
            return \Mollie\Laravel\MollieManager::api();
        }
...
namespace Lisennk\Laravel\SlackWebApi\Facades { 
    ...
    class SlackApi {
         ...
         * @static 
         */ 
        public static function execute($method, $parameters = array())
        {
            return \Lisennk\Laravel\SlackWebApi\SlackApi::execute($method, $parameters);
        }
        ...
        {
            return \Lisennk\Laravel\SlackWebApi\SlackApi::isOk();
        }
        ...
        {
            return \Lisennk\Laravel\SlackWebApi\SlackApi::setToken($token);
        }
         ...
         * @static 
         */ 
        public static function ignoreLimit($ignore = true)
        {
            return \Lisennk\Laravel\SlackWebApi\SlackApi::ignoreLimit($ignore);
        }
...
namespace willvincent\Feeds\Facades { 
    ...
    class FeedsFacade {
         ...
         * @param null $options
         * @return \willvincent\Feeds\simplePie 
         * @static 
         */ 
        public static function make($feedUrl = array(), $limit = 0, $forceFeed = false, $options = null)
        {
            return \willvincent\Feeds\FeedsFactory::make($feedUrl, $limit, $forceFeed, $options);
        }
...
namespace nickurt\PwnedPasswords { 
    ...
    class Facade {
        ...
        {
            return \nickurt\PwnedPasswords\PwnedPasswords::getApiUrl();
        }
        ...
        {
            return \nickurt\PwnedPasswords\PwnedPasswords::setApiUrl($apiUrl);
        }
        ...
        public static function getPassword()
        {
            return \nickurt\PwnedPasswords\PwnedPasswords::getPassword();
        }
        ...
        {
            return \nickurt\PwnedPasswords\PwnedPasswords::setPassword($password);
        }
        ...
        {
            return \nickurt\PwnedPasswords\PwnedPasswords::getFrequency();
        }
        ...
        {
            return \nickurt\PwnedPasswords\PwnedPasswords::setFrequency($frequency);
        }
         ...
         * @static 
         */ 
        public static function IsPwnedPassword()
        {
            return \nickurt\PwnedPasswords\PwnedPasswords::IsPwnedPassword();
        }
...
namespace ApiPostcode\Facade { 
    ...
    class Postcode {
         ...
         * @return \ApiPostcode\Client\Address 
         * @static 
         */ 
        public static function fetchAddress($zipCode, $houseNumber)
        {
            return \ApiPostcode\Client\PostcodeClient::fetchAddress($zipCode, $houseNumber);
        }
...
namespace  { 
    ...
    class SlackApi extends \Lisennk\Laravel\SlackWebApi\Facades\SlackApi {}

    class Feeds extends \willvincent\Feeds\Facades\FeedsFacade {}

    class Hashids extends \Vinkla\Hashids\Facades\Hashids {}

    class PwnedPasswords extends \nickurt\PwnedPasswords\Facade {}

    class Postcode extends \ApiPostcode\Facade\Postcode {}
