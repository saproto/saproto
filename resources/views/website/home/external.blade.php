                        ...
                        <div class="col-md-6">
                            <div class="media">
                              ...
                              <div class="media-body">
                                ...
                                <p>Throughout the whole curriculum, Creative Technology students are faced with big ideas and little time. With project groups ranging from 2 to 15 people, this calls for dynamical schedules and different prototyping techniques. Through experience, the students learn to what extend they can develop their prototypes. From quick electrical circuits just to show that it works to advanced prototypes that only need better building materials: CreaTe students have seen it all.</p>
                                <p>Next to creating working prototypes with little design, students also learn to develop lo-fi prototypes to quickly test their designs on the potential user groups.</p>
                              </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="media">
                              ...
                              <div class="media-body">
                                ...
                                <p>One thing Creative Technology stands out for is its diverse, but close community. Students with different nationalities, experiences, interests and skills form the basis on which this community is built. Active and eager students have come together and founded Study Association Proto, which currently consists of circa 500 members and 33 committees, all held together by a full-time student board.</p>
                                <p>Besides organising lots of interesting activities for entertainment and/or educational purposes, the community also strengthens itself with its various ways of thinking: whether it’s more practical and technical, focused on design or art, or even business: everyone can deliver his or her input.</p>
                              </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="media">
                              ...
                              <div class="media-body">
                                ...
                                <p>Combine creativity with technical knowledge and the possibilities are endless. Now include entrepreneurial mindsets and an eye for missing products and new innovations arise. Innovation and improvement of our daily life is the key feature to a CreaTer’s philosophy.</p>
                              </div>
                            </div>
                        </div>
                    </div>
