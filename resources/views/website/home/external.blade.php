        ...
        <div class="col-md-12 col-xl-6 mb-3">
            <div class="card leftborder leftborder-info h-100">
                <div class="card-body">
                    ...
                    <p class="card-text">Throughout the whole curriculum, Creative Technology students are faced with big ideas and little time. Through experience, the students learn to what extent they can develop their prototypes. From quick electrical circuits just to show that it works to advanced prototypes that only need better building materials: CreaTe students have seen it all.</p>

                    <p class="card-text">Interaction Technology aims to combine a scientific mindset with specialist technical knowledge. I-Techers analyse, design, validate and implement intelligent interactive systems in their operational context. Recent developments in hardware and computational technologies are used in all kinds of projects. Students are taught to become the new engineer: bridging disciplines within project groups and understanding tech and their users.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12 col-xl-6 mb-3">
            <div class="card leftborder leftborder-info h-100">
                <div class="card-body">
                    ...
                    <p class="card-text">Combine creativity with technical knowledge and the possibilities are endless. Now include entrepreneurial mindsets and an eye for missing products and new innovations arise. Innovation and improvement of our daily life is the key feature to a Creative or Interaction Technologist’s philosophy.</p>
                </div>
            </div>
        </div>
    </div>
