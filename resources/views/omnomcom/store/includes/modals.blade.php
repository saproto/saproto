    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-center">
            <div class="modal-body">
                ...
                <span class="modal-status">
                    It looks like you've scanned your card incorrectly. Please close this window, try again and hold
                    your card close to the reader!
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-center">
            <div class="modal-body">
                ...
                <span class="modal-status">
                    It seems you are trying to scan a randomized NFC card. Make sure to
                    <b>not</b>
