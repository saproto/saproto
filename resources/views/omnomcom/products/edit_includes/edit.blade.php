                ...
                <div class="col-md-6">
                    <label for="supplier_collo">
                        ...
                        <span
                            ...
                            title="The amount of units in a package when bought. (e.g.: there are 24 cans in a tray)"
                        >
                            (?)
                        </span>
                        :
                ...
                <div class="col-md-3">
                    <label for="stock">
                        ...
                        <i
                            ...
                            title="This is the amount of the product before you stock the shelves. This amount is for checking the stock for theft. If you are only reporting theft, make sure that the final stock is set to the same value."
                        ></i>
                    </label>
                    <input
                        type="number"
                ...
                <div class="col-md-3">
                    <label for="stock">
                        ...
                        <i
                            ...
                            data-bs-toggle="tooltip"
                            data-bs-placement="right"
                            title="This is the updated amount, put your new stock amounts here."
                        ></i>
                    </label>
                    <input
                        type="number"
