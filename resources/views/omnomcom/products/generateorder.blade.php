                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            as set for that product. This list <strong>only</strong> includes products that are set to
                            'be in stock by default' and that need to be re-ordered to have sufficient stock. This is
                            determined by the <i>Visible in the OmNomCom even when out of stock</i> checkbox in the
                            product's settings. To include or exclude products from this list, head over to that
