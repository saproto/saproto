            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        @foreach(Proto\Models\PhotoManager::getAlbums(null, $query, True, True) as $key => $album)
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        @foreach(Proto\Models\PhotoManager::getAlbums(null, $query, False, True) as $key => $album)
