        ...
        <div class="col-md-12 col-lg-10 col-xl-8">
            <div class="card mb-3">
                ...
                <img
                    ...
                    srcset="{!! $photo->getFirstMediaUrl(conversionName: PhotoEnum::SMALL->value) !!} 420w, {!! $photo->getFirstMediaUrl(conversionName: PhotoEnum::MEDIUM->value) !!} 750w, {!! $photo->getFirstMediaUrl(conversionName: PhotoEnum::LARGE->value) !!} 1920w"
