@if ($user->bank != null)
    <div class="card mb-3">
        <div class="card-header bg-dark text-white">SEPA direct withdrawal</div>
        ...
        <div class="card-footer">
            <div class="btn-group btn-block">
                @if (! $user->is_member)
                    <a class="btn btn-outline-danger w-50" data-bs-toggle="modal" data-bs-target="#bank-modal-cancel">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        This action will cancel your current automatic withdrawal authorization. Everything bought up
                        until now will still be withdrawn from this bank account, but no more purchases can be made
                        using this authorization.
                    </p>

                    <p>
                        After all outstanding balance with this authorization has been paid, the authorization will be
                        permanently deleted. If you wish to make purchases in the future, you can always add a new
                        authorization.
                    </p>
                </div>
