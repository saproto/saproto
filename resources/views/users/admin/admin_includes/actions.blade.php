<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <ul class="list-group mb-3">
            ...
            <a class="list-group-item" href="{{ route('user::member::impersonate', ['id' => $user->id]) }}">
                Impersonate
            </a>

            @if ($user->isTempadmin())
                <a href="{{ route('tempadmin::end', ['id' => $user->id]) }}" class="list-group-item">
                    End temporary admin
                </a>
            @else
                <a href="{{ route('tempadmin::make', ['id' => $user->id]) }}" class="list-group-item">
        ...
        <ul class="list-group">
            ...
            <a class="list-group-item" href="{{ route('user::admin::toggle_studied_create', ['id' => $user->id]) }}">
                Has
                {!! $user->did_study_create ? '' : '<strong>not</strong>' !!}
                studied CreaTe.
            </a>
            <a class="list-group-item" href="{{ route('user::admin::toggle_studied_itech', ['id' => $user->id]) }}">
                Has
