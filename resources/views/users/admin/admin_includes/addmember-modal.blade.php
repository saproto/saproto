            ...
            <div class="modal-content">
                    ...
                    <ul>
                        ...
                        @if (! $user->completed_profile)
                            <li class="text-danger">
                                <strong>
                                    {{ $user->calling_name }} has not yet completed their membership profile. Please
                                    ask them to complete their membership profile before making them a member.
                                </strong>
                            </li>
                        @endif
                        ...
                        @if (! $user->signed_membership_form)
                            <li class="text-danger">
                                <strong>
                                    {{ $user->calling_name }} has not signed the membership form digitally, make sure
                ...
                <div class="modal-footer">
                    ...
                    @if ($user->address && $user->bank && $user->completed_profile && $user->signed_membership_form)
                        <button type="submit" class="btn btn-success">Make member</button>
                    @endif
                </div>
            </div>
        </form>
