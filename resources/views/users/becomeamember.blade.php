    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="list-group">
                ...
                <a href="{{ route("login::register") }}?wizard=1" class="list-group-item @if(Auth::check()) list-group-item-success becomeamember__done @endif">
                    <div class="row">
                        <div class="col-md-1 becomeamember__number">@if(Auth::check())<i class="fa fa-check" aria-hidden="true"></i>@else 1 @endif
                        </div>
                ...
                <a href="@if(Auth::check()) {{ route('user::utwente::add', ['id' => $user->id]) }}?wizard=1 @else # @endif" class="list-group-item @if($user && $user->utwente_username) list-group-item-success becomeamember__done @endif @if(!Auth::check()) becomeamember__future @endif">
                    <div class="row">
                        <div class="col-md-1 becomeamember__number">@if($user && $user->utwente_username)<i class="fa fa-check" aria-hidden="true"></i>@else 2 @endif</div>
                        <div class="col-md-11 becomeamember__description">
                ...
                <a href="@if(Auth::check()) {{ route("user::bank::add", ["id"=>$user->id]) }}?wizard=1 @else # @endif" class="list-group-item @if($user && $user->bank) list-group-item-success becomeamember__done @endif @if(!Auth::check()) becomeamember__future @endif">
                    <div class="row">
                        <div class="col-md-1 becomeamember__number">@if($user && $user->bank)<i class="fa fa-check" aria-hidden="true"></i>@else 3 @endif</div>
                        <div class="col-md-11 becomeamember__description">
                ...
                <a href="@if(Auth::check()) {{ route('user::address::add', ['id' => $user->id]) }}?wizard=1 @else # @endif" class="list-group-item @if($user && $user->address) list-group-item-success becomeamember__done @endif @if(!Auth::check()) becomeamember__future @endif">
                    <div class="row">
                        <div class="col-md-1 becomeamember__number">@if($user && $user->address)<i class="fa fa-check" aria-hidden="true"></i>@else 4 @endif</div>
                        <div class="col-md-11 becomeamember__description">
                ...
                <a href="{{ route('page::show', ['slug' => 'board']) }}" class="list-group-item @if($user && $user->member) list-group-item-success becomeamember__done @endif @if(!Auth::check() || !($user->address && $user->bank)) becomeamember__future @endif">
                    <div class="row">
                        <div class="col-md-1 becomeamember__number">@if($user && $user->member)<i class="fa fa-check" aria-hidden="true"></i>@else 5 @endif</div>
                        <div class="col-md-11 becomeamember__description">
                ...
                <a href="#" class="list-group-item @if($user && $user->member) list-group-item-success @endif @if(!Auth::check() || !$user->member) becomeamember__future @endif">
                    <div class="row">
                        <div class="col-md-1 becomeamember__number">@if($user && $user->member)<i class="fa fa-trophy" aria-hidden="true"></i>@else 6 @endif</div>
                        <div class="col-md-11 becomeamember__description">
