...
@section('body')
    ...
    <p>
        Welcome as the newest member of Study Association Proto! My name is {{ Config::string('proto.internal') }} and
        I would like to give a little introduction to the association. The room where you probably just signed up in is
        our association room called the Protopolis. In this room we offer free coffee and tea and sell other foods and
    ...
    <p>
        ...
        and educative. You can sign up for these activities on our
    ...
    <p>
        ...
        . You can use this username instead of your e-mail address to log-in.
    </p>
    ...
    <p>
        ...
        synchronizing your password to your username
        <a href="{{ route('login::password::sync::index') }}">here</a>
        .
    </p>

    <p>
        Please note: as a member of S.A. Proto you accept our
        <a href="https://wiki.proto.utwente.nl/ict/privacy/start?do=export_pdf" target="_blank">privacy policy</a>
        . Please know that if you want to be updated when changes to the privacy policy are made, you should subscribe
        for notifications in the
        <i>e-mail lists</i>
        section of your
