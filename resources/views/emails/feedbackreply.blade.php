...
@section('body')
    ...
    <p>
        The board saw your feedback and replied! If you have any questions or remarks simply reply to this email.
    </p>

    <p>
        You posted the following feedback to the {{$feedback->category->title}}:
    </p>
