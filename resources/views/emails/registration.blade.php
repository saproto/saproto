...
@section('body')
    ...
    <p>
        ...
        . If this wasn't you, please reply to this e-mail and we'll sort everything out. If it was you, great! Welcome!
        You will receive a separate e-mail with instructions on how to set your password.
    </p>

    <p>
        Just as a heads-up, registering an account doesn't make you a member of Study Association Proto. If you're
        interested in becoming a member, please do follow the instructions over
    ...
    <p>
        ...
        should subscribe for notifications in the
        <i>e-mail lists</i>
        section of your
