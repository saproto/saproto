...
@section('body')
    ...
    <p>
        ...
        reply to this e-mail and we'll sort everything out. If it was you, great! Welcome! You will receive a separate
        e-mail with instructions on how to set your password.
    </p>
