...
@section('body')
    ...
    <p>
        You receive this e-mail because you are needed by one or more activities! The activities that need your help are listed below.
    </p>

    <p>
        The organization of <i>{{ $help->activity->event->title }}</i>
