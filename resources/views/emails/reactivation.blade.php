...
@section('body')
    ...
    <p>
        You receive this e-mail because your account on the website of <a href="{{ route('homepage') }}">Study
            Association Proto</a> has been re-activated. Welcome back! You will receive a separate e-mail with
