...
@section('body')
    ...
    <p>
        Hey {{ User::orderByRaw("RAND()")->first()->calling_name }},
    </p>
    ...
    <p>
        As an additional remark, the name chosen to preface this e-mail is randomly generated. It is not necessarily yours!
    </p>
