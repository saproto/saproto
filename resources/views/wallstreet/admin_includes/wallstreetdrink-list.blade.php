                ...
                <tbody>
                    @foreach ($allDrinks as $wallstreetDrink)
                        <tr class="align-middle text-nowrap">
                            ...
                            <td>
                                {{ Carbon::createFromTimestamp($wallstreetDrink->start_time, \Carbon\CarbonTimeZone::create(config('app.timezone')))->format('m-d-Y H:i') }}
                            </td>
                            <td>
                                {{ Carbon::createFromTimestamp($wallstreetDrink->end_time, \Carbon\CarbonTimeZone::create(config('app.timezone')))->format('m-d-Y H:i') }}
                            </td>
                                        ...
                                        [
                                            ...
                                            'message' =>
                                                ...
                                                Carbon::createFromTimestamp(
                                                    ...
                                                    \Carbon\CarbonTimeZone::create(config('app.timezone')),
                                                )->format('m-d-Y H:i'),
                                            'confirm' => 'Close',
                                        ]
                                    )
