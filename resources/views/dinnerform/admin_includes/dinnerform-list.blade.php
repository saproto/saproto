                    ...
                    <tr class="align-middle text-nowrap">
                        ...
                        <td class="text-center">
                            @if($dinnerform->isCurrent())
                                <i class="far fa-clock text-success" data-bs-toggle="tooltip" data-bs-placement="top"
                                   title="Open"></i>
                            @elseif($dinnerform->closed)
                                <i class="fas fa-check text-primary" data-bs-toggle="tooltip" data-bs-placement="top"
                                   title="Processed"></i>
                            @else
                                <i class="fas fa-ban text-warning" data-bs-toggle="tooltip" data-bs-placement="top"
                                   title="Closed"></i>
                            @endif
                        </td>
