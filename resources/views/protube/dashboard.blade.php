...
@section('container')
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="card mb-3">
                <div class="card-header bg-dark text-white">ProTube settings</div>
                    ...
                    <p class="card-text">
                        ...
                        @if ($usercount > 0)
                            ...
                            <p class="card-text">
                                ...
                                songs in ProTube. You can anonimyze your history. We will keep the songs for historic
                                purposes, but we will remove your name from them. This action is irreversible.
                                ...
                                <script nonce="{{ csp_nonce() }}">
                                    document
                                        ...
                                        .addEventListener('click', (_) => confirm('Are you sure?'))
                                </script>
                            </p>
                        @endif
                    </p>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header bg-dark text-white">Your personal top hits</div>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header bg-dark text-white">Recently played</div>
