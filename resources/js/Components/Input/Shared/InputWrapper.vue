...
<template>
    <div
        class="shadow rounded flex items-center m-0 p-0 ring-blue-600 focus-within:ring-1"
    >
        ...
        <div
            ...
            :class="
                variantStyles[beforeVariant] +
                ' ' +
                (beforeHover ? hoverStyles[beforeVariant] : '')
            "
        >
            <slot name="before" />
        </div>
        <div
            ...
            :class="
                variantStyles[afterVariant] +
                ' ' +
                (afterHover ? hoverStyles[afterVariant] : '')
            "
        >
            <slot name="after" />
        </div>
