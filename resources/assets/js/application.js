...
let timers=Array.from(document.getElementsByClassName("december-countdown"));
    ...
    var timing = setInterval( // you're making an interval - a thing, that is updating content after number of miliseconds, that you're writing after comma as second parameter
        function () {
            ...
            if (timeLeft <= 0) {
                ...
                document.getElementById("december-countdown").innerHTML = "It's over"; //if there's no time left, program in this 2 lines is clearing interval (nothing is counting now)
