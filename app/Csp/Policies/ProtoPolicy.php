    ...
    public function configure(): void
    {
        $this
            ...
            ->addDirective(Directive::CONNECT, [
                ...
                sprintf('ws://%s:%s', getenv('PUSHER_HOST'), getenv('PUSHER_PORT')),
                sprintf('wss://%s:%s', getenv('PUSHER_HOST'), getenv('PUSHER_PORT')),
                ...(getenv('APP_ENV') != 'production' ? ['ws://localhost:*', 'http://localhost:*', 'ws://127.0.0.1:*'] : []),
            ]);
    }
}
