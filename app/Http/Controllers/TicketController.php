...
class TicketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $ticket->buy_limit = $request->input('buy_limit') ?? 0;
     ...
     */
    public function unscan($barcode = null): RedirectResponse
    {
        if ($barcode == null) {
    ...
    public function buyForEvent(Request $request, Event $event)
    {
        ...
        Session::flash('flash_message', 'Order completed successfully! You can find your tickets on this event page.');
