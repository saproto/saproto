    ...
    public function becomeAMemberOf()
    {
        ...
        $steps = [
            ...
            [
                ...
                'icon' => 'fas fa-trophy',
                'text' => "You're almost a full-fledged Proto member! You'll need to find one of the board-members to finalize your registration. They can usually be found in the Protopolis (Zilverling A230) or on our discord server (saproto.nl/go/discord).",
            ],
            [
