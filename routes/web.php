...
Route::group(['middleware' => ['forcedomain']], static function () {
    ...
    Route::group(['prefix' => 'headerimage', 'middleware' => ['auth', 'permission:header-image'], 'as' => 'headerimage::'], static function () {
    ...
    Route::group(['prefix' => 'ldap', 'as' => 'ldap::', 'middleware' => ['utwente']], static function () {
    ...
    Route::group(['as' => 'login::'], static function () {
    ...
    Route::group(['prefix' => 'user', 'as' => 'user::', 'middleware' => ['auth']], static function () {
        ...
        Route::group(['prefix' => '{id}/member', 'as' => 'member::', 'middleware' => ['auth', 'permission:registermembers']], static function () {
            ...
            Route::group(['prefix' => 'omnomcomsound', 'as' => 'omnomcomsound::', 'middleware' => ['auth', 'permission:board']], static function () {
        ...
        Route::group(['prefix' => 'memberprofile', 'as' => 'memberprofile::', 'middleware' => ['auth']], static function () {
        ...
        Route::group(['prefix' => 'admin', 'as' => 'admin::', 'middleware' => ['auth', 'permission:board']], static function () {
        ...
        Route::group(['prefix' => 'registrationhelper', 'as' => 'registrationhelper::', 'middleware' => ['auth' => 'permission:registermembers']], static function () {
        ...
        Route::group(['prefix' => 'address', 'as' => 'address::'], static function () {
        ...
        Route::group(['prefix' => 'diet', 'as' => 'diet::'], static function () {
            Route::post('edit', ['as' => 'edit', 'uses' => 'UserDashboardController@editDiet']);
        });
        /* Routes related to bank accounts. */
        Route::group(['prefix' => 'bank', 'as' => 'bank::'], static function () {
        ...
        Route::group(['prefix' => 'rfidcard/{id}', 'as' => 'rfid::'], static function () {
        ...
        Route::group(['prefix' => 'profilepic', 'as' => 'pic::'], static function () {
        ...
        Route::group(['prefix' => 'edu', 'as' => 'edu::'], static function () {
        ...
        Route::group(['prefix' => '2fa', 'as' => '2fa::'], static function () {
    ...
    Route::group(['prefix' => 'memberform', 'as' => 'memberform::', 'middleware' => ['auth']], static function () {
        ...
        Route::group(['prefix' => 'download', 'as' => 'download::'], static function () {
    ...
    Route::group(['prefix' => 'committee', 'as' => 'committee::'], static function () {
        Route::group(['prefix' => 'membership', 'as' => 'membership::', 'middleware' => ['auth', 'permission:board']], static function () {
    ...
    Route::group(['prefix' => 'society', 'as' => 'society::'], static function () {
        Route::get('list', ['as' => 'list', 'uses' => 'CommitteeController@overview'])->defaults('showSociety', true);
        Route::get('{id}', ['as' => 'show', 'uses' => 'CommitteeController@show']);
    });
    /* Routes related to narrowcasting. */
    Route::group(['prefix' => 'narrowcasting', 'as' => 'narrowcasting::'], static function () {
    ...
    Route::group(['prefix' => 'membercard', 'as' => 'membercard::'], static function () {
    ...
    Route::group(['prefix' => 'joboffers', 'as' => 'joboffers::'], static function () {
    ...
    Route::group(['prefix' => 'leaderboards', 'as' => 'leaderboards::', 'middleware' => ['auth', 'member']], static function () {
        ...
        Route::group(['middleware' => ['permission:board']], static function () {
        ...
        Route::group(['prefix' => 'entries', 'as' => 'entries::'], static function () {
    ...
    Route::group(['prefix' => 'dinnerform', 'as' => 'dinnerform::', 'middleware' => ['auth']], static function () {
        Route::group(['middleware' => ['permission:tipcie']], static function () {
        ...
        Route::group(['prefix' => 'orderline', 'as' => 'orderline::'], static function () {
    ...
    Route::group(['prefix' => 'wallstreet', 'as' => 'wallstreet::', 'middleware' => ['permission:tipcie']], static function () {
     ...
     */
    Route::group(['prefix' => 'events', 'as' => 'event::'], static function () {
        Route::group(['prefix' => 'financial', 'as' => 'financial::', 'middleware' => ['permission:closeactivities']], static function () {
            Route::get('', ['as' => 'list', 'uses' => 'EventController@finindex']);
            Route::post('close/{id}', ['as' => 'close', 'uses' => 'EventController@finclose']);
        });
        Route::group(['prefix' => 'categories', 'middleware' => ['permission:board'], 'as' => 'category::'], static function () {
    ...
    Route::group(['prefix' => 'page', 'as' => 'page::'], static function () {
        Route::group(['middleware' => ['auth', 'permission:board']], static function () {
            ...
            Route::group(['prefix' => '/edit/{id}/file', 'as' => 'file::'], static function () {
    ...
    Route::group(['prefix' => 'news', 'as' => 'news::', 'middleware' => ['member']], static function () {
        Route::group(['middleware' => ['auth', 'permission:board']], static function () {
    ...
    Route::group(['prefix' => 'menu', 'as' => 'menu::', 'middleware' => ['auth', 'permission:board']], static function () {
    ...
    Route::group(['prefix' => 'tickets', 'middleware' => ['auth'], 'as' => 'tickets::'], static function () {
        Route::group(['middleware' => ['auth', 'permission:board']], static function () {
    ...
    Route::group(['prefix' => 'email', 'middleware' => ['auth', 'permission:board'], 'as' => 'email::'], static function () {
        Route::get('', ['as' => 'admin', 'uses' => 'EmailController@index']);
        Route::get('filter', ['as' => 'filter', 'uses' => 'EmailController@filter']);
        Route::group(['prefix' => 'list', 'as' => 'list::'], static function () {
        ...
        Route::group(['prefix' => '{id}/attachment', 'as' => 'attachment::'], static function () {
    ...
    Route::group(['prefix' => 'omnomcom', 'as' => 'omnomcom::'], static function () {
        ...
        Route::group(['prefix' => 'orders', 'middleware' => ['auth'], 'as' => 'orders::'], static function () {
            ...
            Route::group(['prefix' => 'filter', 'middleware' => ['permission:omnomcom'], 'as' => 'filter::'], static function () {
        ...
        Route::group(['prefix' => 'tipcie', 'middleware' => ['auth', 'permission:tipcie'], 'as' => 'tipcie::'], static function () {
            Route::get('', ['as' => 'orderhistory', 'uses' => 'TIPCieController@orderIndex']);
        });
        /* Routes related to Financial Accounts. */
        Route::group(['prefix' => 'accounts', 'middleware' => ['permission:finadmin'], 'as' => 'accounts::'], static function () {
        ...
        Route::group(['prefix' => 'payments', 'middleware' => ['permission:finadmin'], 'as' => 'payments::'], static function () {
        ...
        Route::group(['prefix' => 'products', 'middleware' => ['permission:omnomcom'], 'as' => 'products::'], static function () {
        ...
        Route::group(['prefix' => 'categories', 'middleware' => ['permission:omnomcom'], 'as' => 'categories::'], static function () {
        ...
        Route::group(['prefix' => 'withdrawals', 'middleware' => ['permission:finadmin'], 'as' => 'withdrawal::'], static function () {
        ...
        Route::group(['prefix' => 'mollie', 'middleware' => ['auth'], 'as' => 'mollie::'], static function () {
    ...
    Route::group(['prefix' => 'webhook', 'as' => 'webhook::'], static function () {
    ...
    Route::group(['prefix' => 'video', 'as' => 'video::'], static function () {
        Route::group(['prefix' => 'admin', 'middleware' => ['permission:board'], 'as' => 'admin::'], static function () {
    ...
    Route::group(['prefix' => 'announcement', 'as' => 'announcement::'], static function () {
        Route::group(['prefix' => 'admin', 'middleware' => ['permission:sysadmin'], 'as' => ''], static function () {
    ...
    Route::group(['prefix' => 'photos', 'as' => 'photo::'], static function () {
        ...
        Route::group(['prefix' => 'admin', 'middleware' => ['permission:protography'], 'as' => 'admin::'], static function () {
    ...
    Route::group(['prefix' => 'spotify', 'middleware' => ['auth', 'permission:board'], 'as' => 'spotify::'], static function () {
        Route::get('oauth', ['as' => 'oauth', 'uses' => 'SpotifyController@oauthTool']);
    });
    /* Routes related to roles and permissions. */
    Route::group(['prefix' => 'authorization', 'middleware' => ['auth', 'permission:sysadmin'], 'as' => 'authorization::'], static function () {
    ...
    Route::group(['prefix' => 'passwordstore', 'middleware' => ['auth'], 'as' => 'passwordstore::'], static function () {
    ...
    Route::group(['prefix' => 'alias', 'middleware' => ['auth', 'permission:sysadmin'], 'as' => 'alias::'], static function () {
    ...
    Route::group(['prefix' => 'protube', 'as' => 'protube::'], static function () {
    ...
    Route::group(['prefix' => 'welcomeMessages', 'middleware' => ['auth', 'permission:board'], 'as' => 'welcomeMessages::'], static function () {
    ...
    Route::group(['prefix' => 'tempadmin', 'as' => 'tempadmin::', 'middleware' => ['auth', 'permission:board']], static function () {
    ...
    Route::group(['prefix' => 'qr', 'as' => 'qr::'], static function () {
    ...
    Route::group(['prefix' => 'short_url', 'as' => 'short_url::', 'middleware' => ['auth', 'permission:board']], static function () {
    ...
    Route::group(['prefix' => 'dmx', 'as' => 'dmx::', 'middleware' => ['auth', 'permission:board|alfred']], static function () {
        ...
        Route::group(['prefix' => 'override', 'as' => 'override::'], static function () {
    ...
    Route::group(['prefix' => 'queries', 'as' => 'queries::', 'middleware' => ['auth', 'permission:board']], static function () {
    ...
    Route::group(['prefix' => 'minisites', 'as' => 'minisites::'], static function () {
        Route::group(['prefix' => 'isalfredthere', 'as' => 'isalfredthere::'], static function () {
    ...
    Route::group(['prefix' => 'codex', 'as' => 'codex::', 'middleware' => ['auth', 'permission:senate']], static function () {
